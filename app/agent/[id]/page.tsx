                              ...
                              : agent.id.includes("youtube")
                                ...
                                : agent.id.includes("chat")
                                  ...
                                  : agent.id.includes("twitter")
                                    ...
                                    : agent.id.includes("instagram")
                                      ? "Provided content suggestions"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <select className="w-full p-2 rounded-md bg-gray-800 border border-gray-700 text-white">
                      <option value="active" selected={agent.status === "active"}>
                        Active
                      </option>
                      <option value="development" selected={agent.status === "development"}>
                        In Development
                      </option>
